...
function drawCanvas(radius) {
    ...
    ctx.lineTo(xAxis, yAxis - 1/2*radius * yNameAxis);
    ctx.arc(xAxis, yAxis, 1/2*(xAxis - (6 - radius) * xNameAxis), -Math.PI / 2, 0);
    ...
    ctx.moveTo(xAxis, yAxis);
    ctx.lineTo(xAxis, yAxis + 5 * yNameAxis);
    ctx.lineTo(xAxis - 5 * xNameAxis, yAxis);
